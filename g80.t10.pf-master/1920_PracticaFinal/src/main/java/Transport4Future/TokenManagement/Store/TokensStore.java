...
//			System.out.println("Token Store Object cannot be cloned");
	...
	public void Overwrite (Token newToken) throws TokenManagementException {
		Token result = Find(newToken.getSignature());
		if (result!=null) {
			tokensList.remove(result);
			tokensList.add(newToken);
			this.Save();
		}
	}
	...
	public void Save () throws TokenManagementException {
		Gson gson = new Gson();  
