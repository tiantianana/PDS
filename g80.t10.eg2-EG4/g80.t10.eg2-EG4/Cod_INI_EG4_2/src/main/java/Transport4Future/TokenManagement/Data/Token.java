...
public class Token {
	...
	public Token (String InputFile) throws TokenManagementException {
		...
		JSONTokenParser myParser = new JSONTokenParser();
		items = (HashMap<String, String>)myParser.ParseJsonFile(InputFile);
		this.device = items.get("Token Request");
		this.requestDate = items.get("Request Date");
		this.notificationEmail = items.get("Notification e-mail");
		...
		this.signature = this.generateHash();
		this.tokenValue = this.generateEncode();
		this.Store();
	}
	...
	private void checkTokenRequestInformationFormat() throws TokenManagementException {
		...
		HashMap<String, TokenRequest> clonedMap = myStore.loadRequestStorage();
	...
	private String generateHash() throws TokenManagementException {
		SHA256Hash myHasher = new SHA256Hash();
		return myHasher.Hash(this.getHeader() + this.getPayload());
	}
	
	private String generateEncode() throws TokenManagementException{
	...
	private void checkEmail() throws TokenManagementException {
		...
		if (!mailPattern.matcher(this.getNotificationEmail()).matches()) {
